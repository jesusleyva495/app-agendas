...
public class ViewHolder_Nota extends RecyclerView.ViewHolder {
    ...
    public interface ClickListener{
        ...
        void onItemLongClick(View view, int position);/*SE EJECUTA AL MANTENER PRECIONADO EN EL ITEM*/
    }
    ...
    public void SetearDatos(Context context, String id_nota, String uid_usuario, String correo_usuario,
                            String fecha_hora_registro, String titulo, String descripcion, String fecha_nota, String estado){
