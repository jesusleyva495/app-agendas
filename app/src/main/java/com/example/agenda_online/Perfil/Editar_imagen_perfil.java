...
public class Editar_imagen_perfil extends AppCompatActivity {
    ...
    private void LecturaDeImagen(){
        ...
        reference.child(user.getUid()).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                Glide.with(getApplicationContext()).load(imagen_perfil).placeholder(R.drawable.imagen_perfil).into(ImagenPerfilActualizar);
            }
    ...
    private void SeleccionarImagenGaleria() {
        ...
        galeriaActivityResultLauncer.launch(intent);
    }

    private ActivityResultLauncher<Intent> galeriaActivityResultLauncer = registerForActivityResult(
    ...
    private void SeleccionarImagenCamara() {
        ...
        values.put(MediaStore.Images.Media.DESCRIPTION, "Descripcion imagen");
